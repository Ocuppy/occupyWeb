        ...
        <div className="flex w-full max-w-lg flex-col items-center gap-8 rounded-lg bg-white px-6 py-10 lg:px-8 lg:py-14 lg:shadow-lg">
          ...
          <div className="flex flex-col items-start gap-3">
            <h3 className="text-2xl font-medium text-[#12141A]">
              Welcome, create a rider account
            </h3>
            <p className="pb-12 text-sm font-medium text-[#606778]">
              Fill this form and our support team will reach out to you
            </p>
            {/* input form  */}
            <form
            ...
            >
              ...
              <div className="relative flex flex-col gap-2">
                ...
                {/* <Input
                  ...
                  onChange={formik.handleChange}
                  onBlur={formik.handleBlur}
                  value={formik.values.estateCloseBy}
                  className={
                    formik.touched.estateCloseBy && formik.errors.estateCloseBy
                      ? "border-red-700"
                      : ""
                  }
                />
